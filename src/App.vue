...
const clientWork = [
  ...
  {
    title: "helpIT x TPC Energy Corporation",
    desc: "A full-stack IT helpdesk and ticketing system for TPC Energy Corporation",
    tech: [
      "Vue 3",
      "Pinia",
      "Element Plus",
...
<template>
  <main class="min-h-screen bg-md-bg text-md-on-bg overflow-x-hidden">
    <!-- Material App Bar -->
    <nav
      class="fixed inset-x-0 top-0 z-50 bg-md-surface/95 backdrop-blur-xl shadow-elevation-2"
    >
      <div
        class="max-w-6xl mx-auto px-4 md:px-6 flex justify-between items-center h-16"
      >
        <span class="font-mono text-sm font-medium text-md-primary select-none"
          >imkaiwhyask</span
        >
        <div class="flex items-center gap-1">
          <a
            href="#about"
            class="px-4 py-2 text-sm font-medium text-md-on-surface hover:text-md-primary hover:bg-md-primary/8 rounded-full transition-all duration-200"
            >About</a
          >
          <a
            href="#skills"
          ...
          <a
            href="#contact"
            class="ml-2 px-5 py-2 bg-md-primary/15 text-md-primary text-sm font-medium rounded-full hover:bg-md-primary/25 transition-all duration-200"
            >Contact</a
          >
        </div>
      </div>
    ...
    <!-- Hero -->
    <section
      class="relative min-h-dvh flex items-center px-6 pt-16 bg-md-bg overflow-hidden"
    >
      <div class="absolute inset-0 grid-bg pointer-events-none" />
      <div
        class="absolute top-1/3 -right-40 w-[500px] h-[500px] rounded-full bg-md-primary/6 blur-[100px] pointer-events-none"
      />
      <div
        class="absolute bottom-0 -left-20 w-96 h-96 rounded-full bg-md-secondary/5 blur-[80px] pointer-events-none"
      />
      ...
      <div class="relative z-10 max-w-5xl mx-auto w-full py-20">
        ...
        >
          ...
          <span class="text-xs font-medium text-md-on-surface"
        ...
        <!-- Display headline -->
        <h1
          class="text-5xl md:text-[80px] font-light tracking-tight leading-[1.1] mb-8 whitespace-pre-line"
        >
          {{ displayed
          }}<span
        ...
        <p
          ...
          :enter="{
            opacity: 1,
            y: 0,
            transition: { delay: 2700, duration: 700 },
          }"
          class="text-lg text-md-on-surface max-w-lg mb-10 leading-relaxed"
        >
          Full-stack developer &amp; systems engineer. I design and ship
          reliable internal tools — from APIs to infrastructure.
        </p>
      ...
      >
        <div class="bg-md-surface shadow-elevation-2 rounded-3xl p-8 md:p-12">
          <div class="flex items-center gap-3 mb-6">
            ...
            <p
              class="font-mono text-xs text-md-secondary tracking-[0.15em] uppercase"
            >
              // about
            </p>
          </div>
          <h2
            class="text-4xl md:text-5xl font-light tracking-tight leading-tight mb-8"
          >
            I turn complexity<br />into clarity.
          </h2>
          <div
            class="grid md:grid-cols-2 gap-8 text-md-on-surface leading-relaxed"
          >
            <p>
              I build full-stack applications and manage infrastructure. My
              focus is creating internal tools that are reliable, simple, and
              actually used by people.
            </p>
            <p>
              I enjoy solving real problems — whether it's approval systems,
              ticketing platforms, or improving workflows through clean code and
              solid architecture.
            </p>
          </div>
        </div>
    ...
    <section id="skills" class="py-24 px-6 bg-md-surface">
      <div class="max-w-5xl mx-auto">
        ...
        >
          <p
            class="font-mono text-xs text-md-secondary tracking-[0.15em] uppercase mb-2"
          >
            // stack
          </p>
        ...
        <div class="space-y-8">
          <div
            ...
            :visible="{
              opacity: 1,
              y: 0,
              transition: { duration: 500, delay: gi * 80 },
            }"
          >
            <p
              class="text-xs font-medium text-md-on-surface/50 tracking-[0.12em] uppercase mb-3"
            >
              {{ group.category }}
            </p>
            <div class="flex flex-wrap gap-2">
              <span
                ...
                :visible="{
                  opacity: 1,
                  scale: 1,
                  transition: { delay: gi * 80 + ii * 45, duration: 350 },
                }"
    ...
    <section id="work" class="py-24 px-6 bg-md-bg">
      <div class="max-w-5xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-4">
          ...
          >
            <div
              class="h-0.5 w-full bg-gradient-to-r from-md-primary via-md-primary/50 to-md-secondary"
            />
            <div class="p-7">
              <div class="flex items-start justify-between mb-4">
                <h3 class="font-mono font-medium text-lg tracking-tight">
                  {{ project.title }}
                </h3>
                <a
                  :href="project.url"
              ...
              <p class="text-md-on-surface text-sm leading-relaxed mb-6">
                {{ project.desc }}
              </p>
              <div class="flex flex-wrap gap-2">
                <span
          ...
          <div
            ...
            :visible="{
              opacity: 1,
              y: 0,
              transition: { duration: 600, delay: projects.length * 80 },
            }"
          ...
          >
            <div
              class="w-10 h-10 rounded-full bg-md-surface flex items-center justify-center mb-3 shadow-elevation-1"
            >
              <Clock class="w-4 h-4 text-md-on-surface/40" />
            </div>
            <p class="text-sm font-medium text-md-on-surface/40 mb-1">
              More coming
            </p>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div class="relative h-40 overflow-hidden bg-md-surface-variant">
              ...
              />
              <div
                class="absolute inset-0 bg-md-bg/20 group-hover:bg-transparent transition-colors duration-300"
              />
              <div
                v-if="client.imgs.length > 1"
                class="absolute top-2 right-2 px-2 py-0.5 bg-md-bg/75 backdrop-blur-sm rounded-full font-mono text-[9px] text-md-on-surface/70"
              >
            ...
            <div class="p-4">
              ...
              <p class="text-md-on-surface text-xs leading-relaxed mb-3">
                {{ client.desc }}
              </p>
    ...
    <section class="py-20 px-6 bg-md-bg">
      <div class="max-w-5xl mx-auto">
        ...
        <div v-if="activityLoading" class="h-28 flex items-center">
          <span class="font-mono text-xs text-md-on-surface/30 animate-pulse"
        ...
        >
          <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            ...
            <span
              ...
              class="font-mono text-xs text-md-on-surface/50"
            >
          ...
          <div class="flex items-center justify-end gap-1.5 mt-1">
            <span class="font-mono text-[10px] text-md-on-surface/30"
              >less</span
            >
            <div
    ...
    <footer class="bg-md-bg border-t border-md-outline/15 py-6 px-6">
      <div
        class="max-w-5xl mx-auto flex items-center justify-between font-mono text-xs text-md-on-surface/40"
      >
        <span>© 2026 kai</span>
        <div class="flex items-center gap-4">
          <a
            href="https://github.com/imkaiwhyask"
            target="_blank"
            class="hover:text-md-primary transition-colors duration-200"
          >
    ...
    <Teleport to="body">
      <Transition name="lightbox">
        ...
        >
          <div
            class="relative max-w-5xl w-full bg-md-surface shadow-elevation-5 rounded-3xl overflow-hidden"
          >
            <img
            ...
            <div class="px-5 py-4 flex items-center justify-between gap-4">
              <p class="font-mono text-xs text-md-on-surface/60 truncate">
                {{ lightboxImg.title }}
              </p>
              <template v-if="lightboxImg.srcs.length > 1">
                <div class="flex items-center gap-2 shrink-0">
                  <button
                    @click="lightboxPrev"
                    class="px-4 py-1.5 rounded-full border border-md-outline/40 text-xs font-medium text-md-on-surface hover:bg-md-surface-variant transition-all"
                  >
                    ← prev
                  </button>
                  <span
                    class="font-mono text-xs text-md-on-surface/40 min-w-[40px] text-center"
                    >{{ lightboxImg.idx + 1 }} /
                    {{ lightboxImg.srcs.length }}</span
                  >
                  <button
                    @click="lightboxNext"
                    class="px-4 py-1.5 rounded-full border border-md-outline/40 text-xs font-medium text-md-on-surface hover:bg-md-surface-variant transition-all"
              ...
              <button
                @click="closeLightbox"
                class="shrink-0 text-xs font-medium text-md-on-surface/40 hover:text-md-on-surface transition-colors"
              >
                close ×
              </button>
            </div>
